...
const HUMAN_PALETTES = {
  ...
  leader_mason:{ o:'#2c2420', c:'#6b4b2f', h:'#5a3824', s:'#d8a478', p:'#241c14', b:'#6b8b48', n:'#304838', e:'#fff' },
  leader_seira:{ o:'#2c2420', c:'#e8a838', h:'#e8a838', s:'#f0c8a0', p:'#241c14', b:'#4078c8', n:'#285078', e:'#fff' },
  leader_toren:{ o:'#282020', c:'#d8b838', h:'#d8b838', s:'#d8a078', p:'#303030', b:'#508070', n:'#303848', e:'#fff' },
  leader_eloa:{ o:'#282018', c:'#d85878', h:'#402820', s:'#f0c0a0', p:'#f0d858', b:'#70a850', n:'#305830', e:'#fff' },
};
...
const TILE_ART = {
  '.': _grassBase,
  ',': (x) => {
    x.fillStyle = '#84ca58'; x.fillRect(0, 0, 16, 16);
    x.fillStyle = '#68b848';
    for (const [i, j] of [[2,4],[12,3],[5,12],[14,10]]) {
      x.fillRect(i, j, 1, 3); x.fillRect(i + 1, j + 1, 1, 2);
    }
  },
  ':': (x) => {
  ...
  '=': (x) => {
    x.fillStyle = '#c8b894'; x.fillRect(0, 0, 16, 16);
    x.strokeStyle = '#a89878'; x.lineWidth = 1;
    x.beginPath();
    for (const y of [4.5, 9.5, 14.5]) { x.moveTo(0, y); x.lineTo(16, y); }
    x.moveTo(5.5, 0); x.lineTo(5.5, 4.5); x.moveTo(12.5, 0); x.lineTo(12.5, 4.5);
    x.moveTo(2.5, 4.5); x.lineTo(2.5, 9.5); x.moveTo(9.5, 4.5); x.lineTo(9.5, 9.5);
    x.moveTo(6.5, 9.5); x.lineTo(6.5, 14.5); x.moveTo(13.5, 9.5); x.lineTo(13.5, 14.5);
    x.stroke();
  },
  'q': (x) => {
    x.fillStyle = '#e8d080'; x.fillRect(0, 0, 16, 16);
    x.fillStyle = '#cdb568';
    for (const [i, j] of _SPECK) x.fillRect(i, j, 1, 1);
  },
  't': (x) => {
  ...
  'A': (x) => {
    _grassBase(x);
    x.fillStyle = '#286c34'; x.fillRect(0, 7, 16, 9);
    x.fillStyle = '#3c8c44'; x.fillRect(1, 4, 6, 8); x.fillRect(7, 2, 7, 11);
    x.fillStyle = '#58a858'; x.fillRect(3, 5, 3, 2); x.fillRect(9, 4, 3, 2);
  },
  'C': (x) => {
    x.fillStyle = '#8a806e'; x.fillRect(0, 0, 16, 16);
    x.fillStyle = '#aaa08a'; x.fillRect(1, 1, 14, 5);
    x.fillStyle = '#706858'; x.fillRect(0, 13, 16, 3);
    x.strokeStyle = '#625a4c'; x.lineWidth = 1;
    x.beginPath(); x.moveTo(5, 6); x.lineTo(3, 11); x.lineTo(8, 14);
    x.moveTo(12, 5); x.lineTo(9, 9); x.lineTo(13, 12); x.stroke();
  },
  'W': (x) => {
  ...
  'v': (x) => {
    x.fillStyle = '#3c80c8'; x.fillRect(0, 0, 16, 16);
    x.fillStyle = '#91602f'; x.fillRect(0, 1, 16, 14);
    x.fillStyle = '#bb8244';
    for (const y of [2, 6, 10]) x.fillRect(0, y, 16, 3);
    x.fillStyle = '#5e3b22'; x.fillRect(1, 0, 2, 16); x.fillRect(13, 0, 2, 16);
  },
  'j': (x) => { // raised water gate / jet
    _floorBase(x);
    x.fillStyle = '#2878c8'; x.fillRect(1, 1, 14, 14);
    x.fillStyle = '#68c8f0'; x.fillRect(3, 1, 3, 14); x.fillRect(10, 1, 3, 14);
    x.fillStyle = '#e8f8ff'; x.fillRect(4, 2, 2, 9); x.fillRect(10, 5, 2, 9);
    x.fillStyle = '#485868'; x.fillRect(0, 0, 16, 2); x.fillRect(0, 14, 16, 2);
  },
  'l': (x) => { // tide-gym floor valve
    _floorBase(x);
    x.fillStyle = '#386878'; x.fillRect(2, 2, 12, 12);
    x.fillStyle = '#58b8d8'; x.fillRect(4, 4, 8, 8);
    x.fillStyle = '#d8f8ff'; x.fillRect(6, 5, 4, 5);
    x.fillStyle = '#206080'; x.fillRect(5, 10, 6, 2);
  },
  'e': (x) => { // circuit-gym floor breaker
    _floorBase(x);
    x.fillStyle = '#303848'; x.fillRect(2, 2, 12, 12);
    x.fillStyle = '#f0c830'; x.fillRect(4, 4, 8, 8);
    x.fillStyle = '#fff4a0'; x.fillRect(6, 3, 4, 5);
    x.fillStyle = '#d06030'; x.fillRect(7, 9, 2, 3);
  },
  'z': (x) => { // active electric barrier
    _floorBase(x);
    x.fillStyle = '#303848'; x.fillRect(0, 0, 16, 2); x.fillRect(0, 14, 16, 2);
    x.fillStyle = '#f8dc38';
    x.fillRect(2, 2, 3, 4); x.fillRect(4, 5, 4, 3); x.fillRect(7, 7, 3, 4); x.fillRect(9, 10, 5, 3);
    x.fillStyle = '#fff8b0'; x.fillRect(3, 2, 1, 3); x.fillRect(6, 6, 1, 2); x.fillRect(9, 8, 1, 2);
  },
  'F': (x) => {
    _grassBase(x);
  ...
  'P': (x) => { // storage PC terminal
    _floorBase(x);
    x.fillStyle = '#526270'; x.fillRect(2, 2, 12, 13);
    x.fillStyle = '#24313c'; x.fillRect(3, 3, 10, 7);
    x.fillStyle = '#62d8e8'; x.fillRect(4, 4, 8, 5);
    x.fillStyle = '#b8f4f8'; x.fillRect(5, 5, 4, 1);
    x.fillStyle = '#e8d050'; x.fillRect(5, 12, 2, 1);
    x.fillStyle = '#e87058'; x.fillRect(9, 12, 2, 1);
  },
  ...
  'V': (x) => { // television/computer
    _floorBase(x);
    x.fillStyle = '#343b48'; x.fillRect(2, 2, 12, 9);
    x.fillStyle = '#8fcbe0'; x.fillRect(4, 4, 8, 5);
    x.fillStyle = '#596574'; x.fillRect(7, 11, 2, 3);
    x.fillRect(4, 14, 8, 1);
  },
  'p': (x) => { // potted plant
    _floorBase(x);
    x.fillStyle = '#347848'; x.fillRect(7, 2, 2, 8);
    x.fillStyle = '#58a858';
    x.fillRect(3, 3, 5, 4); x.fillRect(8, 1, 5, 5); x.fillRect(6, 5, 5, 4);
    x.fillStyle = '#8a5232'; x.fillRect(5, 10, 6, 4);
    x.fillStyle = '#bc7040'; x.fillRect(4, 10, 8, 2);
  },
  'd': (x) => { // writing desk
    _floorBase(x);
    x.fillStyle = '#a46d3a'; x.fillRect(1, 4, 14, 9);
    x.fillStyle = '#d19a58'; x.fillRect(1, 4, 14, 3);
    x.fillStyle = '#f0e6c8'; x.fillRect(4, 2, 7, 4);
    x.fillStyle = '#76502c'; x.fillRect(2, 13, 2, 3); x.fillRect(12, 13, 2, 3);
  },
  'K': (x) => { // kitchen counter with sink
    _floorBase(x);
    x.fillStyle = '#b7c2c8'; x.fillRect(0, 3, 16, 11);
    x.fillStyle = '#e1e7e8'; x.fillRect(0, 3, 16, 3);
    x.fillStyle = '#66808c'; x.fillRect(4, 6, 8, 5);
    x.fillStyle = '#394a52'; x.fillRect(7, 1, 2, 4);
  },
  'J': (x) => { // laboratory console
    _floorBase(x);
    x.fillStyle = '#7b8794'; x.fillRect(1, 2, 14, 13);
    x.fillStyle = '#27333e'; x.fillRect(3, 4, 10, 6);
    x.fillStyle = '#58d4c2'; x.fillRect(4, 5, 8, 4);
    x.fillStyle = '#e8ca50'; x.fillRect(4, 12, 2, 1);
    x.fillStyle = '#e86f58'; x.fillRect(8, 12, 2, 1);
  },
  'B': (x) => { // bed
    _floorBase(x);
...
// `s` is an outdoor sign and an indoor sofa. Keep the outdoor fallback intact
// while giving rooms a semantic fallback when the supplied sofa image is not
// ready yet.
const INDOOR_TILE_ART = {
  's': (x) => {
    _floorBase(x);
    x.fillStyle = '#8f5738'; x.fillRect(1, 5, 14, 8);
...
const Sprites = {
  ...
  init() {
    ...
    for (const ch of Object.keys(INDOOR_TILE_ART)) this.indoorTiles[ch] = _tileCanvas(INDOOR_TILE_ART[ch]);
  ...
  tile(ch, indoor = false) {
    return (indoor && this.indoorTiles[ch]) || this.tiles[ch] || this.tiles[indoor ? '_' : '.'];
  },
  creature(id) { return this.creatures[id] || this.creatures.pidgey; },
  human(kind, facing) {
